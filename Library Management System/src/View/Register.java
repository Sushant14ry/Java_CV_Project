...
public class Register extends JFrame {
	...
	private JPanel getPanel() {
		if (panel == null) {
			panel = new JPanel();
			panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 4), "New Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			panel.setBounds(24, 32, 532, 369);
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setBounds(32, 43, 113, 23);
		}
		return lblNewLabel;
	}
	private JTextField getTextField() {
		if (textField == null) {
			...
			textField.setBounds(232, 42, 263, 29);
	...
	private JLabel getLblPassword() {
		if (lblPassword == null) {
			lblPassword = new JLabel("Full Name");
			lblPassword.setFont(new Font("Arial Black", Font.BOLD, 15));
			lblPassword.setBounds(32, 90, 113, 23);
		}
		return lblPassword;
	}
	private JTextField getTextField_1() {
		if (textField_1 == null) {
			...
			textField_1.setBounds(232, 88, 263, 29);
		}
		return textField_1;
	}
	private JLabel getLblAnswer() {
		if (lblAnswer == null) {
			...
			lblAnswer.setBounds(32, 232, 113, 23);
		}
		return lblAnswer;
	}
	private JLabel getLblYourSecurityQuestion() {
		if (lblYourSecurityQuestion == null) {
			...
			lblYourSecurityQuestion.setBounds(32, 185, 198, 23);
		}
	...
	private JTextField getTextField_2() {
		if (textField_2 == null) {
			...
			textField_2.setBounds(232, 184, 263, 29);
		}
		return textField_2;
	}
	private JTextField getTextField_3() {
		if (textField_3 == null) {
			...
			textField_3.setBounds(232, 230, 263, 29);
		}
		return textField_3;
	}
	...
	private JButton getBtnNewButton_1_1() {
		if (btnNewButton_1_1 == null) {
			...
			btnNewButton_1_1.setBounds(232, 289, 113, 30);
		}
	...
	private JButton getBtnNewButton_1_1_1() {
		if (btnNewButton_1_1_1 == null) {
			...
			btnNewButton_1_1_1.setBounds(393, 289, 102, 30);
		}
