...
public class Leaving_All_Students extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Leaving_All_Students frame = new Leaving_All_Students();
	 ...
	 * Create the frame.
	 */
	public Leaving_All_Students() {
		setUndecorated(true);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(600, 190, 831, 516);
	...
	private JLabel getLblNewLabel_1_3() {
		if (lblNewLabel_1 == null) {
			lblNewLabel_1 = new JLabel("Leaving All Students");
	...
	private JScrollPane getScrollPane_1() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(20, 129, 788, 377);
	...
	private JTable getTable_1() {
		if (table == null) {
			...
			table.setModel(new DefaultTableModel(
				...
				new String[] {
					"Full Name", "Mobile No", "Father Name", "Mother Name", "Email", "Address", "College Name", "Citizen No", "Room No"
				}
			));
		}
		return table;
