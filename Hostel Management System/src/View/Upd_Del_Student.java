...
public class Upd_Del_Student extends JFrame {
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setBounds(243, 553, 97, 38);
		}
		return btnNewButton;
	}
	...
	private JComboBox getComboBox_1() {
		if (comboBox_1 == null) {
			...
			comboBox_1.setBounds(243, 512, 356, 24);
		}
		return comboBox_1;
	}
	...
	private JButton getBtnDelete() {
		if (btnDelete == null) {
			...
			btnDelete.setBounds(367, 553, 102, 38);
		}
		return btnDelete;
	}
	private JTextField getTextField_9() {
		if (textField_9 == null) {
			...
			textField_9.setBounds(243, 470, 356, 24);
		}
		return textField_9;
	}
