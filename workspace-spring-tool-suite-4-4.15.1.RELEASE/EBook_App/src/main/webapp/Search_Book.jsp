...
<body>
	...
	<div class="container-fluid px-5">
		<h3 class="text-center p-2">Search Book</h3>
		<div class="row">
			<%
			String srch_book = request.getParameter("srch_char");
			BookADO_impl sdao = new BookADO_impl(DB_Connect.getConnect());
			List<Book_Details> listrp = sdao.getBookBySearch(srch_book);
